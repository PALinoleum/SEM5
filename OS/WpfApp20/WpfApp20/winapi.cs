...
IntPtr templateFile);
        ...
        [DllImport("kernel32.dll")]
        public static extern bool ReadFile(IntPtr hFile, byte[]
   aSegementArray, uint nNumberOfBytesToRead, [In] ref uint lpReserved,
   ...
   out ulong lpTotalNumberOfFreeBytes);
        ...
        public static extern int RegDeleteKeyA(UIntPtr hKey, [MarshalAs(UnmanagedType.LPStr)] string subKey);
