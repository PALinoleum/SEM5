...
impl_table = implicant_table(simple_impl_list)
print(tabulate(impl_table[1],impl_table[0],tablefmt="simple"))

print(latex_sdnf_func(simple_impl_list))
result = factor_sdnf_table(simple_impl_list)
